...
For this repository's test commands and coverage, see [Testing Siesta](../../../docs/testing.md). Apply the principles above using the project's language and test tools.
